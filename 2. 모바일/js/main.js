...
if ($Qmenuli) {
  window.addEventListener("scroll", (e) => {
    if (window.scrollY >= 0 && window.scrollY <= 449) {
      $Qmenuli?.forEach((j) => {
        j.classList.remove("on");
      });
...
if (nonlogin_area) {
  nonlogin_area.style.display = "none";
}
if (login_area) {
...
if (login_Subscription) {
  login_Subscription.addEventListener("click", (e) => {
    Subscription_button_image.style.borderBottom = "red";
    login_area.style.left = "20%";
    nonlogin_area.style.display = "none";
    login_area.style.display = "block";
...
if (nonlogin_Subscription) {
  nonlogin_Subscription.addEventListener("click", (e) => {
    Subscription_button_image.style.borderBottom = "red";
    nonlogin_area.style.left = "20%";
    login_area.style.display = "none";
    nonlogin_area.style.display = "block";
